...
<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
    ...
    <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
        ...
        <div class="text-dark order-2 order-md-1">
            ...
            <a href="#" target="_blank" class="text-dark-75 text-hover-primary">bandmstudio</a>
        </div>
        <!--end::Copyright-->
        <!--begin::Nav-->
        <div class="nav nav-dark">
            <a href="#" target="_blank" class="nav-link pl-0 pr-5">О нас</a>
            <a href="#" target="_blank" class="nav-link pl-0 pr-5">Команда</a>
            <a href="#" target="_blank" class="nav-link pl-0 pr-0">Контакты</a>
        </div>
        <!--end::Nav-->
    </div>
    <!--end::Container-->
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                <a href="#"
                   class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ $user->first_name }}</a>
                ...
                <div class="navi mt-2">
                    ...
                    <a href="{{ route('logout') }}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Выйти</a>
                </div>
            </div>
        </div>
        <!--end::Header-->
        ...
        <div class="navi navi-spacer-x-0 p-0">
            ...
            <a href="" class="navi-item">
                <div class="navi-link">
                    ...
                    <div class="navi-text">
                        ...
                        <div class="text-muted">Редактирование аккаунта</div>
                    </div>
                </div>
            </a>
            <!--end:Item-->
            ...
            <a href="" class="navi-item">
                <div class="navi-link">
                    ...
                    <div class="navi-text">
                        <div class="font-weight-bold">Мои сообщения</div>
                        <div class="text-muted"> новых сообщений
                        </div>
                    </div>
                </div>
            </a>
...
<script src="{{ URL::asset('assets/js/pages/crud/forms/widgets/bootstrap-datetimepicker.js') }}"></script>
