        ...
        <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat"
            ...
            <div class="login-form text-center p-7 position-relative overflow-hidden">
                ...
                <div class="login-signin">
                    <div class="mb-20">
                        <h3 class="">Войдите в систему Администратора</h3>
                        <div class="text-muted font-weight-bold">Введите свои данные для входа в свою учетную запись:
                        </div>
                    </div>
                    <form class="form" id="kt_login_signin_form" action="{{ route('loginPost') }}" method="post">
                        {{ csrf_field() }}
                        <div class="form-group mb-5">
                            <input class="form-control h-auto form-control-solid py-4 px-8" type="text"
                                   placeholder="Login" name="username" autocomplete="off"/>
                        </div>
                        <div class="form-group mb-5">
                        ...
                        <div class="form-group d-flex flex-wrap justify-content-between align-items-center">
                            <div class="checkbox-inline">
                                <label class="checkbox m-0 text-muted">
                                    ...
                                    <span></span>Запомни меня</label>
                            </div>
                            <a href="javascript:;" id="kt_login_forgot" class="text-muted text-hover-primary">Забыли
                                Пароль ?</a>
                        </div>
                        <button id="kt_login_signin_submit"
                                class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4">Вход
                        </button>
                    </form>
                    <div class="mt-10">
                        <span class="opacity-70 mr-4">У вас еще нет учетной записи?</span>
                        <a href="javascript:;" id="kt_login_signup"
                           class="text-muted text-hover-primary font-weight-bold">Зарегистрируйтесь!</a>
                    </div>
                </div>
                ...
                <div class="login-signup">
                    ...
                    <form class="form" id="kt_login_signup_form" action="{{ route('registerPost') }}" method="post">
                        {{ csrf_field() }}
                        <div class="form-group mb-5">
                            <input class="form-control h-auto form-control-solid py-4 px-8" type="text"
                                   placeholder="Логин" name="fullname"/>
                        </div>
                        <div class="form-group mb-5">
                        ...
                        <div class="form-group mb-5">
                            <input class="form-control h-auto form-control-solid py-4 px-8" type="password"
                                   placeholder="Подтвердите Пароль" name="cpassword"/>
                        </div>
                        <div class="form-group mb-5">
                            <input class="form-control h-auto form-control-solid py-4 px-8" type="text"
